			...
			<%if(success!=null){%>
				...
				<%}%>
					...
					<nav class="navbar">
						...
						<div class="nav-right">
							<span class="nav-text">Don't have an account? <strong><a href="signup.jsp">Sign
										Up</a></strong></span>
					...
					<div class="login-container">
						...
						<div class="login-hero">
							<h1>Welcome Back!</h1>
							<p>Log in to your BGS Tours account to access exclusive deals, manage your bookings, and
								explore more destinations.</p>
